 ...
 * config file.
 *
 * 文件xample_formatters.c用作创建一个小型的自定义appenders and formatters库
 *
 ...
 *
 * 这个是实验性的，还没有投入使用。但是这是一个很好的例子，可以查看在调用appender期间
 * 可以访问的所有内容
 */
